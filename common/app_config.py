...
class Config(BaseConfig):
    ...
    MAILJET_API_SECRET: str = Field(env='MAILJET_API_SECRET')
    MAILJET_MAIL_FROM: str = Field(env='MAILJET_MAIL_FROM')
    MAILJET_MAIL_FROM_NAME: str = Field(env='MAILJET_MAIL_FROM_NAME')

    MAILJET_WELCOME_EMAIL_TEMPLATE_ID: int = Field(env='MAILJET_WELCOME_EMAIL_TEMPLATE_ID')
    MAILJET_RESET_PASSWORD_TEMPLATE_ID: int = Field(env='MAILJET_RESET_PASSWORD_TEMPLATE_ID')
